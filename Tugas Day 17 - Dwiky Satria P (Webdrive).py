...
class TestLoginRegister(unittest.TestCase): 
    ...
    #Test Auto 1 - Menampilkan Website    
    ...
    #Test Auto 2 - Melakukan Click login tetapi tanpa menginput username dan password
    ...
    #Test Auto 3 - Terjadi Error (galat) karena salah menginput username dan password
